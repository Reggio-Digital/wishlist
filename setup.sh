...
echo "✅ Setup complete!"
echo ""
echo "📱 Your wishlist app is ready at: http://localhost:3000"
echo "🔑 Admin login: http://localhost:3000/admin/login"
echo ""
echo "Sample wishlists have been created automatically:"
echo "  • Dad's Wishlist: http://localhost:3000/dads-wishlist"
echo "  • Mom's Wishlist: http://localhost:3000/moms-wishlist"
echo ""
